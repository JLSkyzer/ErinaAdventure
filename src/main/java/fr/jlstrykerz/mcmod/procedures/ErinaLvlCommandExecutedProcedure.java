...
public class ErinaLvlCommandExecutedProcedure extends MinecraftmodModElements.ModElement {
	public ErinaLvlCommandExecutedProcedure(MinecraftmodModElements instance) {
		super(instance, 73);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				MinecraftmodMod.LOGGER.warn("Failed to load dependency entity for procedure ErinaLvlCommandExecuted!");
			return;
		}
		if (dependencies.get("cmdparams") == null) {
			if (!dependencies.containsKey("cmdparams"))
				MinecraftmodMod.LOGGER.warn("Failed to load dependency cmdparams for procedure ErinaLvlCommandExecuted!");
			return;
		}
		...
		if ((((new Object() {
			...
			if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
				((PlayerEntity) entity).sendStatusMessage(new StringTextComponent("\u00A7e/ErinaLvl give <number>"), (false));
			}
			if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
				((PlayerEntity) entity).sendStatusMessage(new StringTextComponent("\u00A7e/ErinaLvl take <number>"), (false));
			}
			if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
				((PlayerEntity) entity).sendStatusMessage(new StringTextComponent("\u00A7e/ErinaLvl set <number>"), (false));
			}
		}
	}
}

...
public class ELogoItem extends MinecraftmodModElements.ModElement {
	@ObjectHolder("minecraftmod:e_logo")
	public static final Item block = null;
	public ELogoItem(MinecraftmodModElements instance) {
		super(instance, 74);
	}

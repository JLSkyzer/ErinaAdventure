...
public class DiamondNuggetsItem extends MinecraftmodModElements.ModElement {
	@ObjectHolder("minecraftmod:diamond_nuggets")
	public static final Item block = null;
	public DiamondNuggetsItem(MinecraftmodModElements instance) {
		super(instance, 53);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("diamond_nuggets");
		}

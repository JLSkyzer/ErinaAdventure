...
public class BloodNuggetsItem extends MinecraftmodModElements.ModElement {
	@ObjectHolder("minecraftmod:blood_nuggets")
	public static final Item block = null;
	public BloodNuggetsItem(MinecraftmodModElements instance) {
		super(instance, 28);
	}

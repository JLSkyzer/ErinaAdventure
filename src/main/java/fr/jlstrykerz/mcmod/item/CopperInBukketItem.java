...
public class CopperInBukketItem extends MinecraftmodModElements.ModElement {
	@ObjectHolder("minecraftmod:copper_in_bukket")
	public static final Item block = null;
	public CopperInBukketItem(MinecraftmodModElements instance) {
		super(instance, 95);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("copper_in_bukket");
		}

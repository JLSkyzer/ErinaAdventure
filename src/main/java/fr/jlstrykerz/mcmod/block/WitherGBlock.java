...
import fr.jlstrykerz.mcmod.procedures.WitherGUpdateTickProcedure;
...
public class WitherGBlock extends MinecraftmodModElements.ModElement {
	@ObjectHolder("minecraftmod:wither_g")
	public static final Block block = null;
	public WitherGBlock(MinecraftmodModElements instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				WitherGUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 1200);
		}
	}

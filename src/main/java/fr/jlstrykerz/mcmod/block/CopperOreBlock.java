...
public class CopperOreBlock extends MinecraftmodModElements.ModElement {
	@ObjectHolder("minecraftmod:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(MinecraftmodModElements instance) {
		super(instance, 92);

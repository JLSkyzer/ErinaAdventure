...
public class Plant1Block extends MinecraftmodModElements.ModElement {
	@ObjectHolder("minecraftmod:plant_1")
	public static final Block block = null;
	public Plant1Block(MinecraftmodModElements instance) {
		super(instance, 62);

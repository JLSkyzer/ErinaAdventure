...
import fr.jlstrykerz.mcmod.procedures.GetLvlProcedure;
...
public class GetLvlKeyKeyBinding extends MinecraftmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public GetLvlKeyKeyBinding(MinecraftmodModElements instance) {
		super(instance, 70);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.get_lvl_key", GLFW.GLFW_KEY_K, "key.categories.gameplay");
		...
		if (type == 0) {
			{
				...
				GetLvlProcedure.executeProcedure($_dependencies);
			}
		}
	}
}

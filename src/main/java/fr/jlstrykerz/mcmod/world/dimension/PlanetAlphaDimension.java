...
package fr.jlstrykerz.mcmod.world.dimension;
...
public class PlanetAlphaDimension extends MinecraftmodModElements.ModElement {
	public PlanetAlphaDimension(MinecraftmodModElements instance) {
		super(instance, 82);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("minecraftmod:planet_alpha"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
